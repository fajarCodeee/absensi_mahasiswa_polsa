...
<div class="page-inner">
    ...
    <div class="row">
        ...
        $last_pertemuan = mysqli_query($con, "SELECT COUNT(*) FROM tb_kontrak WHERE id_mengajar='$_GET[pelajaran]' GROUP BY pertemuan_ke ORDER BY pertemuan_ke DESC LIMIT 1  ");
        ...
        <div class="col-lg-8">
            <div class="card">
                <div class="card-header d-flex align-items-center">
                    <h3 class="h4">Form Entry Kontrak Perkuliahan</h3>
                </div>
                <div class="card-body">
                    <form action="" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <input name="daftar" type="text" class="form-control" placeholder="Siswa Hadir...">
                        </div>
                    ...
                    if (isset($_POST['save'])) {
                        ...
                        $daftar = $_POST['daftar'];
                        $insert = mysqli_query($con, "INSERT INTO tb_kontrak VALUES (NULL,'$pelajaran','$materi','$pertemuan','$daftar','$today') ");
