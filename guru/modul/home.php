<div class="panel-header bg-primary-gradient">
	<div class="page-inner py-5">
		<div class="d-flex align-items-left align-items-md-center flex-column flex-md-row">
			<div>
				<h2 class="text-white pb-2 fw-bold">Absensi Mahasiswa</h2>
				<h3 class="text-white op-7 mb-2">Selamat Datang Di Halaman Guru, <b class="text-warning"><?= $data['nama_guru']; ?></b></h3>
			</div>
			...
			<div class="card full-height">
				<div class="card-body">
					<div class="card-title">
						<center>
							<img src="../assets/img/download.png" width="100">
							<br>
							<b>Politeknik Sawunggalih Aji Kutoarjo</b>
						</center>
					</div>
								...
								foreach ($mengajar as $dm) { ?>
									<li class="list-group-item">
										<a class="btn btn-primary btn-block text-left" href="?page=absen&pelajaran=<?= $dm['id_mengajar'] ?> ">
											...
											<span class="sub-item"><?= strtoupper($dm['mapel']); ?> (<?= strtoupper($dm['nama_kelas']); ?> <?= strtoupper($dm['semester']); ?>)</span>
										</a>
									</li>
								<?php } ?>
							</ul>
