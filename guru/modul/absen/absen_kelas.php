			...
			<div class="card-body">
				<form action="" method="post">
					...
					<div class="card-list">
						...
						<input type="date" name="tgl" id="start" class="form-control" value="<?= date('Y-m-d') ?>" style="background-color: #212121;color: #FFEB3B;">
						<div class="status mt-0">
							<div class="form-check">
								<label class="form-check-label">
									<input name="" class="form-check-input" id="selecth" type="checkbox" value="H">
							...
							<div class="item-list">
								...
								<div class="info-user">
									...
									<div class="status mt-0">
										<div class="form-check">
											<label class="form-check-label">
												<input name="ket-<?= $i; ?>" class="itemh" type="checkbox" value="H">
												<span class="form-check-sign">H</span>
											</label>
