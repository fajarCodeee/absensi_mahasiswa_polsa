              ...
              <tr>
                ...
                <td>
                  <select class="form-control" name="prodi">
                    ...
                    <?php
                    $sqlprodi = mysqli_query($con, "SELECT * FROM tb_prodi
    ORDER BY id_prodi ASC");
                    while ($prodi = mysqli_fetch_array($sqlprodi)) {
                      echo "<option value='$prodi[id_prodi]'>$prodi[prodi]</option>";
                    }
                    ?>
                  </select>
                </td>
                ...
                <td>
                  <select class="form-control" name="semester">
                    ...
                    while ($semester = mysqli_fetch_array($sqlsemester)) {
                      echo "<option value='$semester[id_semester]'>$semester[semester]</option>";
                    }
                    ?>
                  </select>
                </td>
