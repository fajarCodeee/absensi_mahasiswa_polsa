		...
		<div class="col-md-12 col-xs-12">
			<div class="card">
 			...
 			-->
				...
				<div class="card-body">
					<a target="_blank" href="../admin/modul/rekap/rekap_persemester.php?pelajaran=<?= $_GET[pelajaran] ?>&kelas=<?= $_GET[kelas] ?>" class="btn btn-default">
						...
						CETAK BULAN (<?php echo strtoupper(namaBulan($bulan)); ?>)
							...
							<table width="100%" border="1" cellpadding="2" style="border-collapse: collapse;">
								<tr>
									...
									<td colspan="<?= $tglTerakhir; ?>" style="padding: 8px;">BULAN : <b style="text-transform: uppercase;"><?php echo namaBulan($bulan); ?> <?= date('Y'); ?></b></td>
								...
								<tr>
									...
									?>
									<td bgcolor="#808080" align="center">H</td>
								...
								?>
									...
									<tr bgcolor="<?= $warna; ?>">
										...
										<td align="center" style="font-weight: bold;">
											<?php
											$sakit = mysqli_fetch_array(mysqli_query($con, "SELECT COUNT(ket) AS hadir FROM _logabsensi WHERE id_siswa='$d[id_siswa]' and ket='H' and MONTH(tgl_absen)='$bulan' and id_mengajar='$_GET[pelajaran]' "));
											echo $sakit['hadir'];
