...
$kelasMengajar = mysqli_query($con, "SELECT * FROM tb_mengajar, tb_master_mapel, tb_mkelas, tb_semester, tb_thajaran, tb_prodi where tb_mengajar.id_mapel=tb_master_mapel.id_mapel and tb_mengajar.id_mkelas=tb_mkelas.id_mkelas and tb_mengajar.id_prodi=tb_prodi.id_prodi and tb_prodi.id_prodi='$kelas' and tb_mengajar.id_semester=tb_semester.id_semester and tb_mengajar.id_thajaran=tb_thajaran.id_thajaran and tb_thajaran.status='1'");
