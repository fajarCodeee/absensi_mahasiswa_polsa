...
<?php
$id_login = @$_SESSION['wakadir'];
$sql = mysqli_query($con, "SELECT * FROM wakadir 
INNER JOIN tb_guru ON wakadir.id_guru=tb_guru.id_guru
 WHERE id_wakadir = '$id_login' AND wakadir.id_guru=tb_guru.id_guru") or die(mysqli_error($con));
...
<head>
	...
	<title>Wakil Direktur | Presensi Mahasiswa</title>
			...
			<div class="sidebar-wrapper scrollbar scrollbar-inner">
				<div class="sidebar-content">
					...
					<ul class="nav nav-primary">
						...
						<li class="nav-item">
							<a href="?page=dosen" class="collapsed">
						...
						<!-- <li class="nav-item">
							...
							<div class="collapse" id="siswa">
								<ul class="nav nav-collapse">
									<?php
									$kelas = mysqli_query($con, "SELECT * FROM tb_siswa
									...
									foreach ($kelas as $k) { ?>
										<li>
											<a href="?page=siswa&siswa=<?= $k['id_siswa'] ?> ">
						...
						<li class="nav-item">
							<a data-toggle="collapse" href="#siswa1">
								<i class="fas fa-user-friends"></i>
								<p>Data Mahasiswa</p>
								<span class="caret"></span>
							</a>
							<div class="collapse" id="siswa1">
								<ul class="nav nav-collapse">
